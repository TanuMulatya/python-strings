...
store_items = [["C1", "Pizza", 89],
               ["C2", "Chicken with Spaghetti", 100],
               ["C3", "Chicken with Fries", 96],
               ["B1", "Burger", 90],
               ["B2", "Pasta", 110],
               ["B3", "Burger with Fries", 100],
               ["Y1", "Soda", 20],
               ["Y2", "Soda with Fries", 50],
               ["S1", "Pizza Pie", 60],
               ["S2", "Pie with/ Fries", 80],
               ]
user_input = None
